...
export default class SnackDetailsComponent extends Component {
	...
	calculate() {
		/*LOGGGGGG*/
		console.log(
			'this.state.snack.servingSize: ' + this.state.snack.servingSize
		);
		console.log(
			'this.state.snack.servingSizeUnit: ' + this.state.snack.servingSizeUnit
		);
		console.log(
			'this.state.snack.labelNutrients.calories.value: ' +
				this.state.snack.labelNutrients.calories.value
		);
		console.log(
			'this.state.snack.labelNutrients.sugars.value: ' +
				this.state.snack.labelNutrients.sugars.value
		);
		console.log(
			'this.state.snack.labelNutrients.fat.value: ' +
				this.state.snack.labelNutrients.fat.value
		);
		console.log(
			'this.state.snack.labelNutrients.saturatedFat.value: ' +
				this.state.snack.labelNutrients.saturatedFat.value
				? this.state.snack.labelNutrients.saturatedFat.value
				: 'NOOOOO'
		);
		console.log(
			'this.state.snack.labelNutrients.sodium.value: ' +
				this.state.snack.labelNutrients.sodium.value
		);
		console.log(
			'this.state.snack.labelNutrients.transFat.value: ' +
				this.state.snack.labelNutrients.transFat.value
		);
		/*LOGGGGGG*/
		...
		if (gInputUser !== this.state.snack.servingSize) {
			// Calories.
			score.calories =
				score.gRatio * this.state.snack.labelNutrients.calories.value;
		} else {
			// Calories.
		...
		score.totalFat =
			((this.state.snack.labelNutrients.fat.value * 9) / score.calories) * 100;
		...
		score.satFat =
			((this.state.snack.labelNutrients.saturatedFat.value * 9) /
				score.calories) *
			100;
		...
		if (gInputUser !== this.state.snack.servingSize) {
			// Sodium.
			score.sodium =
				score.gRatio * this.state.snack.labelNutrients.sodium.value; // In case that quantity is not the same as the db, adjust it.
		} else {
			// Sodium.
		...
		// Sugar (35% Weight).
		score.sugar =
			(this.state.snack.labelNutrients.sugars.value / gInputUser) * 100;
	...
	render() {
		return (
			<Container className='mt-4'>
					...
					<Col>
						<Card>
							<Card.Body>
								...
								<Form.Group
									controlId='formControlPortion'
									style={{ width: '300px', margin: '10px auto' }}
								>
									<Form.Label>
										Portion Size {this.getUnitCalculation()}:
									</Form.Label>
									<Form.Control
										id='portion'
										type='text'
										placeholder={this.getUnit()}
									/>
								</Form.Group>
								...
								<Dropdown as={ButtonGroup}>
									...
									<Dropdown.Menu id='dropdown-units-button' title='Units'>
										...
										<Dropdown.Item
											href=''
											onClick={() => {
												this.setUnitCalculation('Tablespoon');
												this.setUnit('100 tbsp');
											}}
										>
											Tablespoon
										</Dropdown.Item>
										<Dropdown.Item
											href=''
											onClick={() => {
												this.setUnitCalculation('Tea Spoon');
												this.setUnit('100 tsp');
											}}
										>
											Tea Spoon
										</Dropdown.Item>
										<Dropdown.Item
											href=''
											onClick={() => {
												this.setUnitCalculation('Ounces');
												this.setUnit('100 oz');
											}}
										>
											Ounces
										...
										<Dropdown.Item
											href=''
											onClick={() => {
												this.setUnitCalculation('Kilogram');
												this.setUnit('100 kg');
											}}
										>
											Kilograms
										...
										<Dropdown.Item
											href=''
											onClick={() => {
												this.setUnitCalculation('Pounds');
												this.setUnit('100 lbs');
											}}
										>
											Pounds
										</Dropdown.Item>
				...
				>
					<Col>
						<Button className='m-1' variant='primary' href='/snacksgraph'>
							Consume 🍴
						</Button>
